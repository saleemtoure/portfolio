...
const i18n = {
  no: {
    ...
    // ── Professional ──
    navWork: "Erfaring",
    sectionWork: "Erfaring",
    workTitle: "Der jeg har jobbet.",
    jobNow: "nå",
    jobMajmioRole: "Administrerende direktør",
    jobMajmioWhere: "Majmio",
    jobDialogRole: "Sertifisert DialogPilot (oppdragsbasert)",
    jobDialogWhere: "DialogPilotene",
    jobIrRole: "Marketing Officer",
    jobIrWhere: "Islamic Relief Norge",
    jobMssPresRole: "President",
    jobMssWhere: "Muslimsk Studentsamfunn",
    jobOpenerRole: "Learning Resource Producer",
    jobOpenerWhere: "The Opener of Knowledge",
    jobAvarnRole: "Sikkerhetsvakt",
    jobAvarnWhere: "Avarn Security Norge",
    jobDeichmanRole: "Library Community Host",
    jobDeichmanWhere: "Deichman bibliotek",
    jobMssMarketingRole: "Head of Marketing",
    jobIssifouRole: "Freelancer and Consultant",
    jobIssifouWhere:
      "Issifou Sports Media · Videographer, Photographer, and Graphic Designer",
    jobTaRole: "Teaching Assistant — INEC1821",
    jobResearchRole: "Scientific Research Assistant",
    jobUioWhere: "Universitetet i Oslo (UiO)",
    jobMcdRole: "Restaurantmedarbeider",
    jobMcdWhere: "McDonald’s",
    jobAmmerudRole: "Basketballtrener barn",
    jobAmmerudWhere: "Ammerud Basket",
    jobOppsalRole: "Sommerbasketballskole-trener",
    jobOppsalWhere: "Oppsal Basket",
  ...
  en: {
    ...
    // ── Professional ──
    navWork: "Professional",
    sectionWork: "Professional",
    workTitle: "Where I've been working.",
    jobNow: "now",
    jobMajmioRole: "Chief Executive Officer",
    jobMajmioWhere: "Majmio",
    jobDialogRole: "Certified DialogPilot (assignment-based)",
    jobDialogWhere: "DialogPilotene",
    jobIrRole: "Marketing Officer",
    jobIrWhere: "Islamic Relief Norge",
    jobMssPresRole: "President",
    ...
    jobOpenerRole: "Learning Resource Producer",
    jobOpenerWhere: "The Opener of Knowledge",
    jobAvarnRole: "Security Guard",
    jobAvarnWhere: "Avarn Security Norge",
    jobDeichmanRole: "Library Community Host",
    jobDeichmanWhere: "Oslo Public Library",
    jobMssMarketingRole: "Head of Marketing",
    jobIssifouRole: "Freelancer and Consultant",
    jobIssifouWhere:
      "Issifou Sports Media · Videographer, Photographer, and Graphic Designer",
    jobTaRole: "Teaching Assistant — INEC1821",
    jobResearchRole: "Scientific Research Assistant",
    jobUioWhere: "University of Oslo (UiO)",
    jobMcdRole: "Restaurant Crew Member",
    jobMcdWhere: "McDonald’s",
    jobAmmerudRole: "Youth Basketball Coach",
    jobAmmerudWhere: "Ammerud Basket",
    jobOppsalRole: "Summer Basketball Camp Coach",
    jobOppsalWhere: "Oppsal Basket",
